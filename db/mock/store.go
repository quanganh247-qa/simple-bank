...
// VerrifyEmailTx mocks base method.
func (m *MockStore) VerrifyEmailTx(arg0 context.Context, arg1 db.VerrifyEmailTxParams) (db.VerrifyEmailTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerrifyEmailTx", arg0, arg1)
	ret0, _ := ret[0].(db.VerrifyEmailTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// VerrifyEmailTx indicates an expected call of VerrifyEmailTx.
func (mr *MockStoreMockRecorder) VerrifyEmailTx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerrifyEmailTx", reflect.TypeOf((*MockStore)(nil).VerrifyEmailTx), arg0, arg1)
}
